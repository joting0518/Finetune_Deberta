...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_name", default="exp_classification_1202_margin", help="name your experiment", type=str)
    parser.add_argument("--contrastive_true", default=0)
    args = parser.parse_args()
    
    main(args)

# python3 script/main.py --config_path ./script/config.json --mode train
